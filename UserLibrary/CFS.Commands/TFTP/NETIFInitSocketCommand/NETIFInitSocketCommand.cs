...
namespace CFS.Commands {
    ...
    [MTI.Core.ProvideAttribute(Categories=new string[] {
            "CFS.Commands"})]
    public partial class NETIFInitSocketCommand : GES.Communications.CCSDSCommand {
        
        private GES.Commands.Definitions.CFSCommandDefinition _CFSCommandDefinition;
        
        private CFS.DataStructures.NETIFInitSocketCommandData _NETIFInitSocketCommandData;
        
        public NETIFInitSocketCommand() {
            // 
            ...
            // 
            this._CFSCommandDefinition = NETIFInitSocketCommand.CreateCFSCommandDefinition();
            // 
            // Construct _NETIFInitSocketCommandData
            // 
            this._NETIFInitSocketCommandData = NETIFInitSocketCommand.CreateNETIFInitSocketCommandData();
            // 
            // Connect Graph
            // 
            this.Connect();
        ...
        public virtual CFS.DataStructures.NETIFInitSocketCommandData NETIFInitSocketCommandData {
            get {
                return this._NETIFInitSocketCommandData;
            }
            set {
                this._NETIFInitSocketCommandData = value;
                this.OnPropertyChanged("NETIFInitSocketCommandData");
            }
        }
        ...
        public virtual void Connect() {
            ...
            this.Connect("CFSCommandDefinition.ApplicationData", "NETIFInitSocketCommandData");
        }
